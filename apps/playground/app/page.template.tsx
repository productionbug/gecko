...
export default function Home() {
  ...
  return (
    <FormProvider {...methods}>
      <body className={`${theme} ${theme === "dark" ? "bg-black text-white" : "bg-white"}`}>
        <div className="min-h-screen bg-surface-secondary p-8">
          <div className="max-w-7xl mx-auto space-y-16">
            {/* Theme Switcher */}
            <div className="flex justify-end">
              <div className="flex items-center gap-3 bg-surface-primary px-4 py-2 rounded-lg shadow">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold text-text-primary">
                @hexpacket/ui Component Playground
              </h1>
              <p className="text-text-secondary">Comprehensive showcase of all UI components</p>
            </div>

            {/* Section 1: Buttons */}
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              <h2 className="text-2xl font-bold text-text-primary border-b pb-2">Buttons</h2>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Button Variants</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Button Sizes</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Button States</h3>
                <div className="flex flex-wrap gap-4">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Loading Button</h3>
                <div className="flex flex-wrap gap-4">
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              <h2 className="text-2xl font-bold text-text-primary border-b pb-2">Form Inputs</h2>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Input</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Textarea</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Date Input</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">OTP Input</h3>
                <div className="max-w-md">
                  <OTPInput
                    value={otpValue}
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Calendar</h3>
                <Calendar
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              <h2 className="text-2xl font-bold text-text-primary border-b pb-2">Form Controls</h2>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Checkbox</h3>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="check3" className="text-text-disabled">
                      Disabled checkbox
                    </label>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Radio</h3>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="radio3" className="text-text-disabled">
                      Disabled option
                    </label>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Switch</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    <Switch disabled />
                    <span className="text-text-disabled">Disabled switch</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Input Error</h3>
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              <h2 className="text-2xl font-bold text-text-primary border-b pb-2">
                Select Components
              </h2>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Single Select</h3>
                <div className="max-w-md">
                  <Select
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Multi Select</h3>
                <div className="max-w-md">
                  <Select
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Filterable Select</h3>
                <div className="max-w-md">
                  <Select
                    value={singleSelectValue}
                    onChange={setSingleSelectValue}
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              ...
              <form onSubmit={handleSubmit(onSubmit as never)} className="space-y-6 max-w-2xl">
                ...
                <div className="space-y-2">
                  <Label>Country</Label>
                  <RHFSelect name="country" placeholder="Select your country">
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Spinner</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Alerts</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Toast Notifications</h3>
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Tooltip</h3>
                <div className="flex flex-wrap gap-4">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Dialog</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Confirm Dialog</h3>
                <div className="flex gap-3">
                  <Button
                    variant="filled"
                    onClick={() =>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Drawer</h3>
                <div className="flex flex-wrap gap-3">
                  <Button
                    variant="filled"
                    onClick={() => {
                  ...
                  <Drawer
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <p className="text-text-tertiary">
                        This is a {drawerPlacement} drawer. You can add any content here.
                      </p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Dropdown</h3>
                <div className="flex gap-3">
                  <Dropdown
                    items={[
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Menu</h3>
                <div className="flex gap-3">
                  <Menu>
            ...
            <section className="space-y-6 bg-surface-primary p-8 rounded-lg shadow">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Markdown</h3>
...
[Link to documentation](#)`}
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Mermaid Diagram</h3>
                <div className="max-w-3xl border p-4 rounded bg-surface-primary">
                  <MermaidDiagram>
                    {`graph TD
    ...
    C --> E[End]`}
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-text-secondary">Pagination</h3>
            ...
            {/* Footer */}
            <div className="text-center text-text-muted pb-8">
