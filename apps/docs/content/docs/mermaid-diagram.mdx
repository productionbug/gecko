...
import { MermaidDiagram } from '@productionbug/gecko';
...
import { MermaidDiagram, Spinner } from '@productionbug/gecko';
...
```tsx
import type { MermaidDiagramProps } from '@productionbug/gecko';
