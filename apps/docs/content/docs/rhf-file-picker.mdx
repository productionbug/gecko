...
import { RHFFilePicker } from '@hexpacket/ui';
import {
...
import { z } from 'zod';
import { RHFFilePicker, RHFInputGroup, Button } from '@hexpacket/ui';
...
```tsx
import { classNames } from '@hexpacket/ui/utils';
...
- Red border via `HPuiRHFFilePicker--error` CSS class when validation fails
