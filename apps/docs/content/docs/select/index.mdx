...
import { BasicSelectExample, WithPlaceholderExample, DisabledOptionsExample, DisabledSelectExample, PlacementOptionsExample } from '@/components/examples/select/basic-examples';
import { GroupedOptionsExample, GroupedWithFilterableExample, WithHeaderAndFooterExample, ComplexGroupingExample, StaticNoteExample } from '@/components/examples/select/static-elements-examples';
...
- `HPuiSelect` - Main container
- `HPuiSelectButton` - Select button
- `HPuiSelectMenu` - Menu container
- `HPuiSelectOption` - Individual option
- `HPuiSelectOption--selected` - Applied to selected options
- `HPuiSelectOption--focused` - Applied to focused option
