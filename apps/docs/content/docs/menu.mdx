...
import { Menu, MenuButton, MenuItem, MenuItems, MenuSeparator, MenuSection, MenuHeading, Button } from '@hexpacket/ui';
...
```tsx
import { Menu, MenuButton, MenuItem, MenuItems } from '@hexpacket/ui';
...
- `HPuiMenu__button` - Menu button
- `HPuiMenu__items` - Menu items container
- `HPuiMenu__item` - Individual menu item
