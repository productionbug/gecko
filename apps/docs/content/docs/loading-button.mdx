...
- `HPuiLoadingButton` - Main container class
- `HPuiLoadingButton--{variant}` - Variant modifier
- `HPuiLoadingButton--{variant}-{color}` - Combined variant and color
- `HPuiLoadingButton--size-{size}` - Size modifier
- `HPuiLoadingButton--loading` - Applied during loading state
- `HPuiLoadingButton--{variant}-loading` - Variant-specific loading state
