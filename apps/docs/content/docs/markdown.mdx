...
import { Markdown } from '@hexpacket/ui';
...
```tsx
import { Markdown, Alert } from '@hexpacket/ui';
...
```tsx
import type { MarkdownProps } from '@hexpacket/ui';
...
The component uses the class name `HPuiMarkdown`. You can target it in your CSS to apply custom styles:
