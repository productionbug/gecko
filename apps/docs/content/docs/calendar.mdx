...
import { Calendar } from '@hexpacket/ui';
...
- `HPuiCalendar` - Main container
- `HPuiCalendar__header` - Month/year header
- `HPuiCalendar__nav` - Navigation arrows
- `HPuiCalendar__body` - Calendar grid
- `HPuiCalendar__day` - Individual day cell
- `HPuiCalendar__day--selected` - Selected day
- `HPuiCalendar__day--active` - Active highlighted day
- `HPuiCalendar__day--today` - Today's date
- `HPuiCalendar__day--disabled` - Disabled day (different month)
