...
- `HPuiPagination` - Main container
- `HPuiPagination__arrow` - Previous/Next buttons
- `HPuiPagination__arrow--previous` - Previous arrow icon
- `HPuiPagination__arrow--next` - Next arrow icon
- `HPuiPagination__page-count` - Page counter display
- `HPuiPagination__page-buttons` - Page number buttons container
- `HPuiPagination__page-button` - Individual page button
- `HPuiPagination__page-button--active` - Active page
- `HPuiPagination__page-button--ellipsis` - Ellipsis button
